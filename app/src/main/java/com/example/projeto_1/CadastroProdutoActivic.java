...
import com.example.projeto_1.modelo.Produto;

public class CadastroProdutoActivic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadastro_produto_activic);
